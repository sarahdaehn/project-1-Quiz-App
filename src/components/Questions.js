...
export default function Questions(props) {
  ...
  useEffect(() => {
    const url =
      "https://quizapi.io/api/v1/questions?apiKey=kGlnNNrvOFUBZ6KFBgANGmWyXn3fUlj6NKHHEQaO&difficulty=Medium&limit=10";
    fetch(url)
      .then((res) => res.json())
      .then((data) => {
    ...
    <>
      <section>
        <div className="question-body">
          <h5 align="center" className="question-title">
            Question
          </h5>
          <p align="center" className="question-text">
            {question}
          </p>
        </div>
